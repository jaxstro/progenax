...
non-differentiable. Q is a validation/demo diagnostic only -- the differentiable
inference interface is the analytic predicted-statistics layer in ``inference/``
(Gaussianization + CIC + POT tail; AC11-AC17), not a fitted Q surrogate.
"""
