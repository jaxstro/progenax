...
class TestQApproxFast:
    ...
    def test_consistent_with_naive(self):
        ...
        from progenax.diagnostics.q_approx import q_approx_fast, q_approx_naive
    ...
    def test_jit_compatible(self):
        ...
        Q = q_jit(positions)
        assert jnp.isfinite(Q), "JIT result should be finite"
    ...
    def test_scales_to_large_n(self):
        ...
        assert jnp.isfinite(Q), "Large N should work"
...
class TestExports:
    ...
    def test_import_from_diagnostics(self):
        ...
        from progenax.diagnostics import q_approx
...
class TestCalibration:
    ...
    def test_monotonicity_preserved(self):
        ...
        clump1 = generate_uniform_sphere_jax(150, key2) * 0.3 + jnp.array(
            [0.5, 0.0, 0.0]
        )
        clump2 = generate_uniform_sphere_jax(
            150, jax.random.PRNGKey(101)
        ) * 0.3 + jnp.array([-0.5, 0.0, 0.0])
