...
next: R2 figure-validation extended — **imf-statistics, binary-imf, environment-IMF now at publication standard and PUSHED to main** (2026-06-08; commits c0b8cfe, d43e0c5, 9c358d9). Remaining ⚠️ dashboard rows: analytical-test-cases (R2) + tidal-truncation (R3, harden-then-validate: needs a NEW validation tier vs analytic Jacobi radius first). gravoturb_fdf/pp20 deferred by instruction.
